...
function yk4_section_icon_shapes()
{
	return array(
		...
		'bento' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><line x1="2.5" y1="4.5" x2="12" y2="4.5"/><line x1="2.5" y1="7.5" x2="8" y2="7.5"/><line x1="16.5" y1="6" x2="21.5" y2="6"/><rect x="2.5" y="11" width="9" height="4" rx="1" fill="currentColor" fill-opacity=".2"/><rect x="12.5" y="11" width="4" height="4" rx="1"/><rect x="17.5" y="11" width="4" height="4" rx="1"/><rect x="2.5" y="16.5" width="4" height="4" rx="1"/><rect x="7.5" y="16.5" width="4" height="4" rx="1"/><rect x="12.5" y="16.5" width="9" height="4" rx="1" fill="currentColor" fill-opacity=".2"/></svg>',
		'steps' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><line x1="2.5" y1="4.5" x2="10" y2="4.5"/><line x1="2.5" y1="7.5" x2="7" y2="7.5"/><rect x="2.5" y="11" width="8" height="5" rx="1" fill="currentColor" fill-opacity=".2"/><rect x="2.5" y="17.5" width="8" height="3" rx="1"/><rect x="13.5" y="3.5" width="8" height="4.6" rx="1"/><rect x="13.5" y="9.7" width="8" height="4.6" rx="1" fill="currentColor" fill-opacity=".2"/><rect x="13.5" y="15.9" width="8" height="4.6" rx="1"/></svg>',
		'proof' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><line x1="2.5" y1="4.5" x2="12" y2="4.5"/><line x1="2.5" y1="7.5" x2="8" y2="7.5"/><line x1="16.5" y1="6" x2="21.5" y2="6"/><rect x="2.5" y="11" width="10" height="6.5" rx="1" fill="currentColor" fill-opacity=".2"/><path d="M6.6 12.9v2.7l2.4-1.35z" fill="currentColor" stroke="none"/><rect x="14" y="11" width="7.5" height="6.5" rx="1"/><line x1="2.5" y1="20.5" x2="6.5" y2="20.5" stroke-width="2.4"/><line x1="8" y1="20.5" x2="21.5" y2="20.5"/></svg>',
		...
		'pricing' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><line x1="8" y1="3.5" x2="16" y2="3.5"/><line x1="10" y1="6.5" x2="14" y2="6.5"/><rect x="2.5" y="10.5" width="5.5" height="10" rx="1"/><rect x="9.25" y="9" width="5.5" height="11.5" rx="1" fill="currentColor" fill-opacity=".2"/><rect x="16" y="10.5" width="5.5" height="10" rx="1"/><line x1="10.5" y1="12.6" x2="13.5" y2="12.6" stroke-width="2.4"/><line x1="10.5" y1="16" x2="13.5" y2="16"/></svg>',
		...
		'faq' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><line x1="2.5" y1="4.5" x2="10" y2="4.5"/><line x1="2.5" y1="7.5" x2="7" y2="7.5"/><rect x="3" y="12.5" width="7" height="7.5" rx="1.5" fill="currentColor" stroke="none"/><rect x="13.5" y="3.5" width="8" height="7.5" rx="1" fill="currentColor" fill-opacity=".2"/><rect x="13.5" y="12.8" width="8" height="3.4" rx="1"/><rect x="13.5" y="17.4" width="8" height="3.4" rx="1"/><circle cx="19" cy="14.5" r=".9" fill="currentColor" stroke="none"/><circle cx="19" cy="19.1" r=".9" fill="currentColor" stroke="none"/></svg>',
	);
}
...
function yk4_editor_sections()
{
	return array(
		...
		'home_benefits' => array('title' => 'Benefits', 'description' => 'A heading above a bento grid of benefit cards, with a chart card and a checklist card.', 'shape' => 'bento'),
		'home_program' => array('title' => 'Program', 'description' => 'A heading, a photo, a facts panel and a button beside a list of numbered program steps.', 'shape' => 'steps'),
		'home_proof' => array('title' => 'Social proof', 'description' => 'A heading with a rating, count-up numbers, a video that plays in a popup, a quote, a chat, reviews, a slider of case studies and a strip of logos.', 'shape' => 'proof'),
		...
		'home_pricing' => array('title' => 'Pricing', 'description' => 'A heading above a row of pricing plans, one of them highlighted, with a footnote under the row.', 'shape' => 'pricing'),
		...
		'home_faq' => array('title' => 'FAQ', 'description' => 'A list of questions that open to their answers, beside a heading and a card to get in touch.', 'shape' => 'faq'),
